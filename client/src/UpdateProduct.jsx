...
// loading: Tracks whether the component is fetching or updating data.
 ...
 // const response = await axios.get(`https://crud-operations-udfx.onrender.com/products/${id}`, { withCredentials: true });
    ...
    const fetchProductDetails = async () => {
        setLoading(true);
        try { 
            const response = await axios.get(`https://crud-operations-rte5.vercel.app/products/${id}`, { withCredentials: true });
            if (response.data) {
        ...
        try {
            const response = await axios.put(
                // `https://crud-operations-udfx.onrender.com/products/${id}`,
                 `https://crud-operations-rte5.vercel.app/products/${id}`,
